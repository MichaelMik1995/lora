<div class="row">
    ...
    <div class="column-4 column-10-xsm column-8-sm column-6-md background-dark-3 pd-2 bd-round-3 content-center mgy-10">
        <form id="login" method="POST" action="/auth/do-login">
            <input hidden type="text" name="token" value="538fb255d54af89e92b41f7ba41b2f0398771d0fb563701e146f7040854f618b"> <input hidden type="text" name="SID" value="e50eef14c5688862574c596915d32888">
