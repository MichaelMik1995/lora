            ...
            <div class="column-shrink pd-2">
                <div class="bd-dark background-dark-2 bd-2 bd-round-3">
                    <div class="t-bold bd-bottom-dark pd-2">
                        <div redirect="<?php echo strtolower($module["name"]) ?>" class="header-6 pdy-1 t-dark t-info">
                    ...
                    <div class="content-right pd-2">
                        <button redirect="admindev/app/module-show/<?php echo strtolower($module["name"]) ?>" class="button button-bd-info bd-round-symetric mgx-1"><i class="fa fa-eye"></i></button>
                        <button onClick="GUIDialog.dialogConfirm('Opravdu chcete smazat modul?', () => {redirect('admindev/app/module-delete/<?php echo $module['name'] ?>')})" class="button button-bd-error bd-round-symetric"><i class="fa fa-trash"></i></button>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
