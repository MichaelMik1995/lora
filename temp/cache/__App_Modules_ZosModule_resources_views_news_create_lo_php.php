<div class="">
    <form method="post" action="/zos/app/news-insert" enctype="multipart/form-data">
        ...
        <div class="form-line">
            ...
            <input id="title" required validation="required,maxchars128" type="text" name="title" class="input-dark pd-1 pdy-2 width-50 width-100-xsm pd-2-xsm">
