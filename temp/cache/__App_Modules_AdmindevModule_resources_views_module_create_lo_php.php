...
<div class="column-6">
    ...
    <div class="">
        <form method="post" action="/admindev/app/module-insert">
            <input hidden type="text" name="token" value="ef5f7034cef19d963d8158c219c69ea4b7532898ae6cab8fa3a9d44a942f4fd3"> <input hidden type="text" name="SID" value="3a462ddafcbe54e0b2a0da23cf3ccd75">
                ...
                <div class="row cols-3 cols-1-xsm">
                    <div class="column-shrink pd-1 content-center">
                        <div class="background-dark pd-2">
                            ...
                            <input id="version" type="text" name="version" class="input-dark" value="<?php echo $WEB_VERSION ?>">
                        </div>
                    </div>
