 ...
 * @author michaelmik
 */
class CreateTableBlog_comments 
{
    /**
    ...
    */
    ...
    public function createOrUpdateTable($factory): Void
    {
        ...
        $blog_url = $factory->createTableColumn("blog_url", "varchar", 128);
        $content = $factory->createTableColumn("content", "varchar", 2048);
