...
class ForumThemeCategoryController extends ForumController 
{
    use Redirect;
    use FormValidator;
    ...
    public function insert()
    {
        ...
        $post = $this->input("title", "required,maxchars128", "Název")
            ...
            ->input("theme-url", "required,maxchars128", "URL Tématu")
        ...
        try {
            ...
            $this->validate();
            $this->model["category"]->insertForumThemeCategory([
                "name"=> $post["title"],
                "url" => $url,
                "theme_url" => $post["theme-url"],
