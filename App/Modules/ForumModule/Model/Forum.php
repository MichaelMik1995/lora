...
class Forum extends Model
{
    ...
    protected $table_themes = "forum-themes";
    protected $table_theme_categories = "forum-categories";

    protected $table_posts = "forum-posts";
    protected $table_post_comments = "forum-post-comments";
     ...
     * @return object <p>Returns all rows from table forum</p>
     */
