<div class="row">
    <div class="display-flex column-5 column-10-xsm content-center ali-center column-justify-center">
        <img rel="easySlider" class="width-95 width-100-xsm " src="./content/uploads/{{ $upload_folder }}/images/{{ $picture['filename'] }}.{{$picture['file_extension']}}">
    </div>
    <div class="column-5 column-10-xsm mgy-2-xsm">
        ...
        <div class="form-line mgy-2">
            ...
            <form method="post" action="/user/app/picture-update-alt/{{ $picture['filename'] }}">
                @csrfgen
                @request(get)
