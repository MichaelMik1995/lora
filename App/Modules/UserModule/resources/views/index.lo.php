...
<div class="row pd-2 pd-0-xsm">
    ...
    <div content-height-auto="user-main" class="column-2 bgr-dark-2 bd-right-dark" style="flex-direction: column; min-height: 100vh">
        ...
        <div class="mgy-2">
            ...
            <div copy-element="user-menu-button" data="icon:key,title:Heslo,redirect:user/app/password-dashboard,listen-url:change-password,description:Změnit heslo"></div>
