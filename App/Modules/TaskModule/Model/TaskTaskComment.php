<?php
/**
 * Description of Module Model - TaskTaskComment:
 *
...
class TaskTaskComment extends Task
{

    protected $model_table = "TaskTaskComment";
     ...
     */
    public function getAllTaskTaskComment(string $order_by = "id ASC"): Array
    {
     ...
     */
    public function getTaskTaskComment(string $url): Array
    {
    ...
    public function insertTaskTaskComment(array $insert_values)
    {
        // Insert new row
        return $this->db->insert($this->model_table, $insert_values);
    }
    
    public function updateTaskTaskComment(array $set, string $url)
    {
        // update row
        return $this->db->update($this->model_table, $set, "url=?", [$url]);
    }
    
    public function deleteTaskTaskComment(string $url)
    {
        // delete row
