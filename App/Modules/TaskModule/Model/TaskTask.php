<?php
/**
 * Description of Module Model - TaskTask:
 *
...
class TaskTask extends Task
{
    ...
    protected $model_table = "TaskTask";
     ...
     */
    public function getAllTaskTask(string $order_by = "id ASC"): Array
    {
     ...
     */
    public function getTaskTask(string $url): Array
    {
    ...
    public function insertTaskTask(array $insert_values)
    {
        // Insert new row
        return $this->db->insert($this->model_table, $insert_values);
    }
    
    public function updateTaskTask(array $set, string $url)
    {
        // update row
        return $this->db->update($this->model_table, $set, "url=?", [$url]);
    }
    
    public function deleteTaskTask(string $url)
    {
        // delete row
