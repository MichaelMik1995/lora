<?php
/**
 * Description of Module Model - TaskStatus:
 *
...
class TaskStatus extends Task
{
    ...
    protected $model_table = "TaskStatus";
     ...
     */
    public function getAllTaskStatus(string $order_by = "id ASC"): Array
    {
     ...
     */
    public function getTaskStatus(string $url): Array
    {
    ...
    public function insertTaskStatus(array $insert_values)
    {
        // Insert new row
        return $this->db->insert($this->model_table, $insert_values);
    }
    
    public function updateTaskStatus(array $set, string $url)
    {
        // update row
        return $this->db->update($this->model_table, $set, "url=?", [$url]);
    }
    
    public function deleteTaskStatus(string $url)
    {
        // delete row
