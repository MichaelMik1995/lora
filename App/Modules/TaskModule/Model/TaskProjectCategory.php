<?php
/**
 * Description of Module Model - TaskProjectCategory:
 *
...
class TaskProjectCategory extends Task
{

    protected $model_table = "TaskProjectCategory";
     ...
     */
    public function getAllTaskProjectCategory(string $order_by = "id ASC"): Array
    {
     ...
     */
    public function getTaskProjectCategory(string $url): Array
    {
    ...
    public function insertTaskProjectCategory(array $insert_values)
    {
        // Insert new row
        return $this->db->insert($this->model_table, $insert_values);
    }
    
    public function updateTaskProjectCategory(array $set, string $url)
    {
        // update row
        return $this->db->update($this->model_table, $set, "url=?", [$url]);
    }
    
    public function deleteTaskProjectCategory(string $url)
    {
        // delete row
