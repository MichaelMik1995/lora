<?php
/**
 * Description of Module Model - TaskTaskCategory:
 *
...
class TaskTaskCategory extends Task
{

    protected $model_table = "TaskTaskCategory";
     ...
     */
    public function getAllTaskTaskCategory(string $order_by = "id ASC"): Array
    {
     ...
     */
    public function getTaskTaskCategory(string $url): Array
    {
    ...
    public function insertTaskTaskCategory(array $insert_values)
    {
        // Insert new row
        return $this->db->insert($this->model_table, $insert_values);
    }
    
    public function updateTaskTaskCategory(array $set, string $url)
    {
        // update row
        return $this->db->update($this->model_table, $set, "url=?", [$url]);
    }
    
    public function deleteTaskTaskCategory(string $url)
    {
        // delete row
