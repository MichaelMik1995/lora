...
class BlogComment extends Blog implements ModelDBInterface
{
    protected $model_table = "BlogComment";
     ...
     */
    public function getAllBlogComment(string $order_by = "id ASC"): Array
    {
     ...
     */
    public function getBlogComment(string $url): Array
    {
    ...
    public function insertBlogComment(array $insert_values)
    {
        // Insert new row
        return $this->database->insert($this->model_table, $insert_values);
    }
    
    public function updateBlogComment(array $set, string $url)
    {
        // update row
        return $this->database->update($this->model_table, $set, "url=?", [$url]);
    }
    
    public function deleteBlogComment(string $url)
    {
        // delete row
