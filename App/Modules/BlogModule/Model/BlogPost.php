...
class BlogPost extends Blog implements ModelDBInterface
{
     ...
     */
    public function getAllBlogPost(string $order_by = "id ASC"): Array
    {
     ...
     */
    public function getBlogPost(string $url): Array
    {
    ...
    public function insertBlogPost(array $insert_values)
    {
        // Insert new row
        return $this->database->insert($this->model_table, $insert_values);
    }
    
    public function updateBlogPost(array $set, string $url)
    {
        // update row
        return $this->database->update($this->model_table, $set, "url=?", [$url]);
    }
    
    public function deleteBlogPost(string $url)
    {
        // delete row
