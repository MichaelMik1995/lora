@backbutton button-custom-main-1 @
...
<div  class="row">
    ...
    <div id='printarea' class="column background-light pd-2 bd-round-3">
        ...
        <div class="row mgy-2">
            <div class="column-3">
                <img src="{{$this->asset('img/logo/main_logo_dark.png')}}" class="height-128p">
            </div>
...
<button class="button button-custom-main-2" id='btn' value='Print' onclick="$('#printarea').print();"><i class="fa fa-print"></i> Tisk/Uložit do PDF</button>
