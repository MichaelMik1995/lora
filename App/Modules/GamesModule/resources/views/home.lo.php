...
<div class="mgy-2 row cols-10 cols-2-xsm cols-4-sm cols-8-xlrg background-bd-create">
    ...
    <div redirect="games/app/board/{{ $genre['slug'] }}" class="column-shrink background-create-hover pd-1 content-center cursor-point anim-all-fast">
        <a class="header-5 header-3-xlrg t-light">{{ $genre["title"] }}</a>
    </div>
    @endforeach
