...
class AdminScheduler extends Admin implements ModelDBInterface
{
     ...
     */
    public function getAllAdminScheduler(string $order_by = "id ASC"): Array
    {
     ...
     */
    public function getAdminScheduler(string $url): Array
    {
    ...
    public function insertAdminScheduler(array $insert_values)
    {
        // Insert new row
        return $this->database->insert($this->model_table, $insert_values);
    }
    
    public function updateAdminScheduler(array $set, string $url)
    {
        // update row
        return $this->database->update($this->model_table, $set, "url=?", [$url]);
    }
    
    public function deleteAdminScheduler(string $url)
    {
        // delete row
