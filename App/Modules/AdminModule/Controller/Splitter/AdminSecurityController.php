...
use App\Modules\AdminModule\Model\AdminSecurity;
...
class AdminSecurityController extends AdminController 
{
     ...
     */
    private string $template_folder = "security/";
     ...
     * @return string
     */
    public function index(AdminSecurity $model) 
    {
