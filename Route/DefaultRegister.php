...
trait DefaultRegister 
{
   public static function register(): Array
   {
       return [
            ...
            ["url"=>"auth/register/rules", "controller"=> AuthController::class, "method"=>"registerRules", "module"=>false, "template"=>"auth/rules", "route" => "auth.rules@default"],
            ...
            ["url"=>"auth/do-register", "controller"=> AuthController::class, "method"=>"doRegister", "request"=>"default", "module"=>false, "route" => "auth.doRegister@insert"],
